...
const skillService = new SkillService(jsonPortfolioDataRetriever);

describe("getSkills", () => {
  test("should return all existing skills", () => {
    const expected = [skill0, skill1, skill2, skill3, skill4, skill5, skill6, skill7];
...
describe("getSkillsByCategory", () => {
  test("should return all the skills by category", () => {
    ...
    const expected = [skill0, skill2, skill5];
